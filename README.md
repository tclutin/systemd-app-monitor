...
systemd-app-monitor — позволяет создавать мониторы для systemd-севрисов, которые автоматически проверяют доступность сервиса по указанному URL с заданным интервалом и перезапускают systemd-сервис при недоступности.
